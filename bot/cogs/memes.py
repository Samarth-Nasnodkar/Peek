...
class Memes(commands.Cog):
    ...
    async def meme(self , ctx):
        ...
        if len(loggedMemes) == 0:
            ...
            embed = discord.Embed(description = f'***__[{memeList[sendable_meme].title}]({memeList[sendable_meme].url})__***' , color = discord.Color.from_rgb(random.randint(0 , 255), random.randint(0 , 255) ,random.randint(0 , 255)))
            ...
            embed = discord.Embed(description = f"***__[{sendable_meme}]({memeList[sendable_meme]['url']})__***" , color = discord.Color.from_rgb(random.randint(0 , 255), random.randint(0 , 255) ,random.randint(0 , 255)))
            embed.set_image(url = memeList[sendable_meme]["url"])
